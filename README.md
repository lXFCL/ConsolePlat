...
Current source version: `v2.4.0`. See `RELEASE_NOTES-v2.4.0.md`.
...
GitHub Release `v2.4.0` provides a bundled Windows x64 package:

```text
ConsolePlat-v2.4.0-windows-x64.zip
```
