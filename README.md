...
Current source version: `v2.4.1`. See `RELEASE_NOTES-v2.4.1.md`.
...
GitHub Release `v2.4.1` provides a bundled Windows x64 package:

```text
ConsolePlat-v2.4.1-windows-x64.zip
```
