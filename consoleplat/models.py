...
DEFAULT_NAV_ITEMS: tuple[NavItem, ...] = (
    ...
    NavItem("purchase", "拿货", "▤", "采集备货数据并生成拿货表"),
    NavItem("local_image", "生图", "✦", "本地印花生成与风格批次"),
    NavItem("ai_edit", "改图", "✎", "AI 图片改造与参考图任务"),
    NavItem("outputs", "产物", "◫", "透明底、产品图、xlsx 校验"),
    NavItem("putaway", "上架", "▷", "衔接 PutawayAiRobot 自动上架"),
...
DEFAULT_TASK_CARDS: tuple[TaskCard, ...] = (
    ...
    TaskCard("拿货表", "读取 SKU / 尺码 / 数量 / 高清图", "sendgoods", "#6ba6ff"),
